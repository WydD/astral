...
public interface HandlerFactory {
    Handler createHandler(String type, Dictionary args, AstralCore core) throws InstanceCreationException;

    Handler createAndAttachHandler(String type, Dictionary args, QueryRuntime runtime)
            throws Exception;

    void prepareHandler(Handler handler, QueryRuntime runtime) throws Exception;
}
