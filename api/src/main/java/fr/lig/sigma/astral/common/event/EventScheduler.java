...
public interface EventScheduler extends TimeChangeListener {
    ...
    /**
     * Set the weak mode of the scheduler. The weak mode enables the top scheduler to toggle push whenever it is not
     * needed anymore
     *
     * @param weakMode true for weak, false for strong
     */
    void setWeakMode(boolean weakMode);

    boolean isWeak();

    void addDependentEventScheduler(EventScheduler es, boolean b);
}
