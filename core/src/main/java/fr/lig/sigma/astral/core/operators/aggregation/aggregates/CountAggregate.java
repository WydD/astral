...
@Provides(strategy = "INSTANCE", properties = {
        @StaticServiceProperty(name= AggregateFactory.NAME_PROPERTY, type="java.lang.String", value="count")
})
public class CountAggregate implements DifferentialAggregateFunction<CountAggregate> {
    ...
    public void removeAggregate(CountAggregate agg) {
        count -= agg.count;
    }

    public void mergeAggregate(CountAggregate agg) {
        count += agg.count;
    }
