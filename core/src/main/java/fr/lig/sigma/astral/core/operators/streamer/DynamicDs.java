...
@Component
@Provides
public class DynamicDs extends StreamOperator implements Operator {
    @Requires(id = "in")
    ...
    public void prepare() throws Exception {
        setOutput((Stream) entityFactory.instanciateEntity("StreamQueueImpl", "DS(" + in.getName() + ")", new AttributeSet(attributes)));
        addInput(in, true);
    }

    @Override
    public void processEvent(Batch b) throws AxiomNotVerifiedException {
        TupleSet deletedTuples = in.getDeletedTuples(b);
